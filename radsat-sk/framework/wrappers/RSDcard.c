...
void DEMO_SD_FileTasks(uint16_t volID){
	uint16_t ret;
 ...
 */
void DEMO_SD_StringFunc( uint16_t volID ){
	F_FILE* file;
	uint16_t ret;
	uint8_t filename[] = "strings.txt";
...
static void _TaskTestFileLogRead( void* pvParam ){
	...
	uint8_t filename[] = "log.bin"; /* a=0, b=1, etc */
