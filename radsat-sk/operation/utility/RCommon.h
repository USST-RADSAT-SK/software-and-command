...
#define MAX_FRAME_COUNT 		(2000)//(2000)
...
/** ADCS Settings */
#define ADCS_CAPTURES_PER_HOUR				(1)			// How many ADCS bursts to capture per hour.
...
#define ADCS_BURST_NUMBER_OF_CAPTURES		(15)		// How many captures to take in a single burst.
#define ADCS_BURST_INTERVAL_MS				(1000)
#define ADCS_DISCARD_MISSED_MEASUREMENTS				// Comment out to stop

/** Dosimeter Settings */
#define DOSIMETER_READINGS_PER_DAY			(24*60)			// How many dosimeter payload readings to collect per day.
#define DOSIMETER_COLLECTION_TASK_DELAY_MS	(MS_PER_DAY / DOSIMETER_READINGS_PER_DAY)//(MS_PER_HOUR / DOSIMETER_READINGS_PER_DAY)		// Dosimeter Collection Task delay (in ms).

/** Watchdog Settings */
#define SATELLITE_WATCHDOG_TASK_DELAY_MS	(100)		// Satellite Watchdog Task delay (in ms)

/** Telemetry Settings */
#define TELEMETRY_READINGS_PER_HOUR			(24*60)		// How many telemetry readings to collect per hour.
#define TELEMETRY_COLLECTION_TASK_DELAY_MS	(MS_PER_DAY / TELEMETRY_READINGS_PER_HOUR)//(MS_PER_HOUR / TELEMETRY_READINGS_PER_HOUR)	// Telemetry Collection Task delay (in ms).
